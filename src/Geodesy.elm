module Geodesy exposing
    ( Coordinates, DegreesMinutesSeconds, Unit(..)
    , decimalDegrees, degreesMinutesSeconds
    , distance, initialBearing, finalBearing, midpoint
    , rhumbDistance, rhumbBearing, rhumbMidpoint
    )
...
-}
distance : Coordinates -> Coordinates -> Unit -> Float
...
-}
initialBearing : Coordinates -> Coordinates -> Float
...
-}
finalBearing : Coordinates -> Coordinates -> Float
...
-}
rhumbDistance : Coordinates -> Coordinates -> Unit -> Float
...
-}
rhumbBearing : Coordinates -> Coordinates -> Float
